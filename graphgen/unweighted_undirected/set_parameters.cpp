...
class Parameters {
	public:
		Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree, double Itau,
							 ...
							 bool Iexcess, bool Idefect, bool Irandomf, double clustering_coeff);
...
Parameters::Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree,
	...
	defect=Idefect;
	randomf=Irandomf;
	clustering_coeff = Iclustering_coeff;
}

Parameters::Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree,
											 double Imixing_parameter, int Inmin, int Inmax)
	: Parameters(Inum_nodes, Iaverage_k, Imax_degree, 2, 1, Imixing_parameter,
							 0, 0, Inmin, Inmax, false, false, false, false, unlikely) {
}
