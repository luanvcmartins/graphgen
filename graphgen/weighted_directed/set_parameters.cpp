...
class Parameters {
	public:
		Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree, double Itau,
							 double Itau2, double Imixing_parameter,
               double Imixing_parameter2, double Ibeta, int Ioverlapping_nodes,
							 int Ioverlap_membership, int Inmin, int Inmax, bool Ifixed_range,
							 bool Iexcess, bool Idefect, bool Irandomf);
		Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree,
							 double Imixing_parameter, double Imixing_parameter2,
               int Inmin, int Inmax);
		Parameters();
		~Parameters(){};
...
Parameters::Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree,
                       double Itau, double Itau2, double Imixing_parameter,
                       double Imixing_parameter2, double Ibeta,
                       int Ioverlapping_nodes, int Ioverlap_membership,
                       int Inmin, int Inmax, bool Ifixed_range,
                       bool Iexcess, bool Idefect, bool Irandomf) {
  num_nodes=Inum_nodes;
  average_k=Iaverage_k;
  max_degree=Imax_degree;
  tau=Itau;
  tau2=Itau2;
  mixing_parameter=Imixing_parameter;
  mixing_parameter2=Imixing_parameter2;
  beta=Ibeta;
  overlapping_nodes=Ioverlapping_nodes;
  overlap_membership=Ioverlap_membership;
  nmin=Inmin;
  nmax=Inmax;
  fixed_range=Ifixed_range;
  excess=Iexcess;
  defect=Idefect;
  randomf=Irandomf;
}
...
Parameters::Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree,
                       double Imixing_parameter, double Imixing_parameter2,
                       int Inmin, int Inmax)
  : Parameters(Inum_nodes, Iaverage_k, Imax_degree, 2, 1, Imixing_parameter,
               Imixing_parameter2, 1.5, 0, 0, Inmin, Inmax, false, false,
               false, false) {
}
...
void statement() {
	...
	cout<<"-k\t\t[average in-degree]"<<endl;
	cout<<"-maxk\t\t[maximum in-degree]"<<endl;
	...
	cout<<"Use option -sup (-inf) if you want to produce a benchmark whose distribution of the ratio of external in-degree/total in-degree ";
