...
class Parameters {
  public:  
    Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree, double Itau, 
      double Itau2, double Imixing_parameter, int Ioverlapping_nodes, 
    ...
    Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree, 
      double Imixing_parameter, int Inmin, int Inmax);
    Parameters();
    ~Parameters(){};
...
Parameters::Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree, 
      double Itau, double Itau2, double Imixing_parameter, int Ioverlapping_nodes, 
      int Ioverlap_membership, int Inmin, int Inmax, bool Ifixed_range, 
      bool Iexcess, bool Idefect, bool Irandomf) {
...
Parameters::Parameters(int Inum_nodes, double Iaverage_k, int Imax_degree, 
  double Imixing_parameter, int Inmin, int Inmax) : Parameters(Inum_nodes, 
    Iaverage_k, Imax_degree, 2, 1, Imixing_parameter, 0, 0, Inmin, Inmax, false,
    false, false, false) {
}
